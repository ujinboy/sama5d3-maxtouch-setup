## linux4sam_6.1 video demo - SAM-BA 2.18 TCL script
## NAND flash layout for FIT image (itb) based boot

set bootstrapFile	"at91bootstrap-sama5d3_xplained.bin"
set ubootFile		"u-boot-sama5d3-xplained.bin"
set itbFile		"sama5d3_xplained.itb"
set rootfsFile		"atmel-qt5-demo-image-sama5d3-xplained.ubi"
...
## NandFlash Mapping (from u-boot-env.txt)
...
## u-boot variables (from u-boot-env.txt)
...
puts "-I- === Load FIT image (kernel + dtb) ==="
send_file {NandFlash} "$itbFile" $itbAddr 0

puts "-I- === Load root file-system ==="
