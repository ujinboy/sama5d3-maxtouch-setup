...
#ifndef fallthrough
#define fallthrough do {} while (0)  /* 또는 __attribute__((__fallthrough__)) */
#endif


#if LINUX_VERSION_CODE < KERNEL_VERSION(5, 4, 0)
#ifndef input_mt_report_slot_inactive
#define input_mt_report_slot_inactive(dev) \
...
static int mxt_stop(struct mxt_data *data)
{
	...
	dev_info(&data->client->dev, "mxt_stop bypassed to keep IRQ active\n");
    return 0;
