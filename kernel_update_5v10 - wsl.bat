@echo off
rem Kernel-only update (kernel 5.10) for SAMA5D3 Xplained
rem Source: WSL Ubuntu-24.04 ~/at91/build/sama5d3_xplained.itb
...
copy /Y \\wsl.localhost\Ubuntu-24.04\home\a41839\at91\build\sama5d3_xplained.itb sama5d3_xplained-kernel_v5.10_wsl.itb
